...
public class Test extends ListenerAdapter
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            JDA jda = JDABuilder.createDefault("OTExMzQwNzA1NjkwMDUwNjAx.YZf-LA.FU4hgBjtYh83D9dczucSP7jM2lU") // The token of the account that is logging in.
                    .addEventListeners(new Test())   // An instance of a class that will handle events.
                    .build();
